...
``fred_pipeline.local_store`` moved to :mod:`fred_pipeline.io.local_store` as part of
...
so every attribute access, ``from fred_pipeline.local_store import X``, and any
test monkeypatching by the old string path all operate on the same
underlying module. New code should still import from
:mod:`fred_pipeline.io.local_store` directly.
"""

import sys as _sys

from fred_pipeline.io import local_store as _real_module
