...
``fred_pipeline.quality`` moved to :mod:`fred_pipeline.validation.quality` as part of
...
so every attribute access, ``from fred_pipeline.quality import X``, and any
test monkeypatching by the old string path all operate on the same
underlying module. New code should still import from
:mod:`fred_pipeline.validation.quality` directly.
"""

import sys as _sys

from fred_pipeline.validation import quality as _real_module
