...
``fred_pipeline.features`` moved to :mod:`fred_pipeline.writer.features` as part of
...
so every attribute access, ``from fred_pipeline.features import X``, and any
test monkeypatching by the old string path all operate on the same
underlying module. New code should still import from
:mod:`fred_pipeline.writer.features` directly.
"""

import sys as _sys

from fred_pipeline.writer import features as _real_module
