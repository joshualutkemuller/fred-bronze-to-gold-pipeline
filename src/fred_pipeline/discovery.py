...
``fred_pipeline.discovery`` moved to :mod:`fred_pipeline.catalogs.discovery` as part of
...
so every attribute access, ``from fred_pipeline.discovery import X``, and any
test monkeypatching by the old string path all operate on the same
underlying module. New code should still import from
:mod:`fred_pipeline.catalogs.discovery` directly.
"""

import sys as _sys

from fred_pipeline.catalogs import discovery as _real_module
